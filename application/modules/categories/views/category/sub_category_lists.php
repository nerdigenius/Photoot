                ...
                <table border="1px solid red" id="example" class="display " style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Sub Category Current Price</th>
                            <th class="text-center">Sub Category Previous Price</th>
                    ...
                    <?php foreach($sub_category_lists as $lists): ?>

                    <tbody>
                        <tr>
                            <td align="center"><?= $lists->sub_category_id; ?></td>
                            <td align="center"><?= $lists->category_id; ?></td>
                            <td align="center"><?= $lists->sub_category_name; ?></td>
                            <td align="center">
                                <?php if($lists->sub_category_image != null){ ?>
                                    <img src="<?php echo base_url($lists->sub_category_image); ?>" alt="product_image">
                                    <?php }else{ ?>
                                        <img src="" alt="no_image_found">
                                    <?php } ?>
                                </td>
                            <td align="center"><?= $lists->sub_category_description; ?></td>
                            <td align="center"><?= $lists->current_price; ?></td>
                            <td align="center"><?= $lists->previous_price; ?></td>
                            <td align="center"><?= $lists->created_on; ?></td>
                            <td align="center"><?= $lists->updated_on; ?></td>
                            <td align="center"><a href="<?= base_url('categories/edit_sub_category/').$lists->sub_category_id; ?>" class="btn btn-info">Edit</a><a href="<?= base_url('categories/delete_sub_category/').$lists->sub_category_id; ?>" onclick="return confirm('Do you really want to delete this product?');" class="btn btn-danger">Delete</a></td>
                        </tr>
                    </tbody>
