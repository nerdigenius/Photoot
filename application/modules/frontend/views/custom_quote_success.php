        ...
        <div class="row" id="stick-part">
            ...
            <div class="col-lg-9 mt-30 top" id="success">
                <div class="alert alert-danger" role="alert">
                    Successfully sent your custom quote request
                </div>
                <div class="top-1">
                    <p class="text-dark">Thank you for using our online custom quote system. <br>
                    The order for relative custom quote has been correctly registered with the number <?=$id?>
                    ...
                    <p class="text-dark">
                        ...
                        your order in real time in the Custom Order tab.
                    </p>
                </div>
                    <p class="text-danger">Very Shortly you will receive a notification, when your requested quote is ready with best price.</p>
                <div class="top-3">
                ...
                <div class="footer-box">
                    ...
                    <a href="<?=base_url('frontend/profile#account-custom-orders')?>" class="btn btn-lg success-btn">click here <i class="fa fa-angle-right"></i></a>
                </div>
