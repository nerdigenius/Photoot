...
<?php include 'menu-header.php'; ?>
 ...
 <!-- Login Modal -->
        <div class="container">
            <div class="row">
                <form id="logForm" method="post" style="margin: 0 auto;">
                    <?php if($this->session->flashdata('passwordChanged')): ?>
                        <div class="text-center col-md-12" style="margin: 0 auto; background-color: green; color: white; font-weight: 700">
                            <p><?php echo $this->session->flashdata('passwordChanged'); ?></p>
                        </div>
                    <?php endif; ?>
