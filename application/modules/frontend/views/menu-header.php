                ...
                <div class="col-lg-8 d-none d-lg-block">
                    ...
                    <nav class="ho-navigation ho-navigation-3">
                        <ul>
                            ...
                            <li>
                                <a href="<?= base_url('frontend/example'); ?>">EXAMPLES</a>
                            </li>
                        </ul>
                    </nav>
                    <!--// Navigation -->
...
<!-- Login Modal -->
<div class="modal fade photoot-modal" id="loginmodal" tabindex="-1" role="dialog" aria-labelledby="loginmodalLabel" aria-hidden="true">
    <form id="logForm" method="post">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a href="<?=base_url('frontend/forgotPassword')?>" class="float-left">Forget Passowrd</a>
...
<div class="modal fade photoot-modal" id="regmodal" tabindex="-1" role="dialog" aria-labelledby="regmodalTitle" aria-hidden="true">
