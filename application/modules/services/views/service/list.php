            ...
            <div class="row">
                <h1>Services List</h1>
                    ...
                    <tbody>
                            ...
                            <td align="center">
                                <?php if($list->service_icon != null){ ?>
                                    <img src="<?php echo base_url($list->service_icon); ?>" alt="service_icon">
                                    <?php }else{ ?>
                            ...
                            <td align="center">
                                <?php if($list->service_image != null){ ?>
                                    <img src="<?php echo base_url($list->service_image); ?>" alt="service_image">
                                    <?php }else{ ?>
                                        <img src="" alt="no_image_found">
                                    <?php } ?>
                            </td>

                            <td align="center"><?= $list->service_description; ?></td>
