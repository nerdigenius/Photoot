                ...
                <h1>Services List</h1>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Charge Hours</th>
                            <th class="text-center">Charge Value</th>
                        </tr>
                    </thead>

                    <?php foreach($charge_list as $list): ?>

                    <tbody>
                        <tr>                        
                            <td align="center"><?= $list->charge_id; ?></td>
                            <td align="center"><?= $list->charge_hours; ?></td>
                            <td align="center"><?= $list->charge_value; ?></td>
                        </tr>                       
                    </tbody>
