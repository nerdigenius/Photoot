...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container">
            <div class="row">
                <h1>Add Service</h1>
                <?php echo form_open_multipart('services/added_additional'); ?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="Price">Service Value: </label>
                            <?php echo form_input(['class' => 'form-control','placeholder' => 'Enter Service Description', 'value' => set_value('service_value'), 'type' => 'varchar', 'name' => 'service_value' ]); ?>
                        </div>
                    </div>
                </div>
